...
* @returns {object} 目标对象
* @example
* console.log(Sumi.Core.cp(0, .3));      // {}
* console.log(Sumi.Core.cp(0, 'abc'));   // { '0': 'a', '1': 'b', '2': 'c' }
* 
* console.log(Sumi.Core.cp({ a: '0' }, { a: 0.1, b: [1, 2, 3], c: '1' }));
* // { a: '0', b: [ 1, 2, 3 ], c: '1' }
* 
* console.log(Sumi.Core.cp({ a: '0' }, { a: 0.1, b: [1, 2, 3], c: '1' }, true));
* // { a: 0.1, b: [ 1, 2, 3 ], c: '1' }
* @example
* var x = { a: 1 };
* var y = { a: 1, b: [1, 2]};
* Sumi.Core.cp(x, y, true);
* console.log(x.b == y.b);               // true
* Sumi.Core.cp(x, y, true, true);
