...
return String.prototype.substr = 'ab'.substr(-1) === 'b' ? f : function (s, l) {
...
* 获取一个从指定位置开始并具有指定长度的子字符串。修正了 Microsoft's JScript 不支持负值 start 参数的错误。
* @see {@link Sumi.String.subReplace}
* @access public
