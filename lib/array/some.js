...
return Array.prototype.some = Array.prototype.some || function(f, t) {
...
*     return element >= 10;
* }
* console.log([5, 8].some(isBigEnough));              // false
* console.log([12, 5, 8].some(isBigEnough));          // true
* console.log([12, 18, 130, 33].some(isBigEnough));   // true
*/
