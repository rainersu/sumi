...
return Array.prototype.every = Array.prototype.every || function(func, that) {
	for(var i = 0, o = O(this), l = o.length >>> 0; i < l; i++) {
		if(i in o && !func.call(that, o[i], i, o)) return false;
    }
	return true;
};
