...
define([
	...
	'./util/hexdec',
	'./util/substr'
], function (G, C, md5, sha1, hexdec, substr) {
	
var rng = 
	(
		function () {
			var crb = new Array(16),
				crt = G.crypto || G.msCrypto;
	...
	BufferClass = G.Buffer || G.ArrayBuffer || Array,
    byteToHex = [],
    hexToByte = {},
	i,
	bytes = rng(),
...
* @returns {string}
* @example
* console.log(UUID.v3('00000000-0000-0000-0000-000000000000', 'google');
* console.log(UUID.v3('6ba7b810-9dad-11d1-80b4-00c04fd430c8', 'google.com'));
*/
...
* @returns {string}
* @example
* console.log(UUID.v5('00000000-0000-0000-0000-000000000000', 'google');
* console.log(UUID.v5('6ba7b810-9dad-11d1-80b4-00c04fd430c8', 'google.com'));
*/

/**
* 将 UUID 字符串解析到数组或缓冲字节流。
* @see {@link UUID.unparse}
* @access public
* @func UUID.parse
...
* @example
* console.log(UUID.parse('797ff043-11eb-11e1-80d6-510998755d10'));
