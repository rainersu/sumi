 ...
 */
var hexcase = options.hexcase,
	b64pad  = options.b64pad,
	chrsz   = options.charset;
/*
...
function binb2str (bin) {
	var b = bin,
		...
		l = b.length * 32;
	for(; i < l; i += c) {
		s+= fromCharCode((b[i >> 5] >>> (32 - c - i % 32)) & m);
	}
	return s;
}
/*
...
* @see {@link Sumi.Crypto.sha256}
* @see {@link Sumi.Crypto.sha512}
* @access public
* @func Sumi.Crypto.sha1
* @param {string} str - 输入文本
* @param {string} [key] - 密钥
* @param {number} [type＝0] - 正数则生成原始字符串。负数则生成Base64编码字符串。默认生成十六进制编码字符串
* @returns {string}
* @example
* console.log(Sumi.Crypto.sha1('abc'));          // a9993e364706816aba3e25717850c26c9cd0d89d
* console.log(Sumi.Crypto.sha1('abc', 'key'));   // 4fd0b215276ef12f2b3e4c8ecac2811498b656fc
*/
