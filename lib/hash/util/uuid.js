define(['../md5'], function (md2) {
    ...
    UUID.prototype.make = function (version) {
        ...
        if (version === 1) {
            ...
            var s = version === 3 ? md2(input, undefined, 2) : sha1(input);
...
console.log(md5('php.net'));
console.log(md2('php.net', undefined, 2)); 
console.log(md5('中国'));
console.log(md2('中国', undefined, 2)); 
console.log(md2('12081977')     === 'dfd8c10c1b9b58c8bf102225ae3be9eb');
console.log(md2('monkey')       === 'd0763edaa9d9bd2a9516280e9044d885');
console.log(md2('message')      === '78e731027d8fd50ed642340b7c9a63b3');
console.log(md2('value')        === '2063c1608d6e0baf80249c42e2be5804');
console.log(md2('value', 'key') === '01433efd5f16327ea4b31144572c67f6');
console.log(new UUID(3, 'ns:DNS', 'php.net').format()); // === '11a38b9a-b3da-360f-9353-a5a725514269');
