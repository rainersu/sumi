...
/**
* 使用 {@link http://en.wikipedia.org/wiki/MD5 MD5} 算法生成一个符合 {@link http://www.ietf.org/rfc/rfc4122.txt RFC4122,v1} 规则基于时间戳的 {@link http://zh.wikipedia.org/wiki/UUID UUID(Universally Unique IDentifier)} 。
