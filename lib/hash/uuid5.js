...
/**
* 使用 {@link http://en.wikipedia.org/wiki/SHA-1 SHA1} 算法生成一个符合 {@link http://www.ietf.org/rfc/rfc4122.txt RFC4122,v5} 规则的 {@link http://zh.wikipedia.org/wiki/UUID UUID(Universally Unique IDentifier)} 。
