...
return function (s, k, x, e) {
	var f = utf16to8;
	s = f(s);
	k = k ? rstr_hmac_sha512(f(k), s) : rstr_sha512(s);
...
* @returns {string}
* @example
* console.log(Sumi.Crypto.sha512("abc"));
* // ddaf35a193617abacc417349ae20413112e6fa4e89a97ea20a9eeee64b55d39a2192992a274fc1a836ba3c23a3feebbd454d4423643ce80e2a9ac94fa54ca49f
* 
* console.log(Sumi.Crypto.sha512('abc', 'key'));
