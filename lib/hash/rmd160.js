...
function binl_rmd160 (x, len) {
	...
	for (l = x.length; i < l; i+= 16) {
		...
		for (j = 0; j <= 79; ++j) {
			...
			T = iadd(bitRol(T, rmd160_s1[j]), E1);
			A1 = E1; E1 = D1; D1 = bitRol(C1, 10); C1 = B1; B1 = T;
			T = iadd(A2, rmd160_f(79-j, B2, C2, D2));
			T = iadd(T, x[i + rmd160_r2[j]]);
			T = iadd(T, rmd160_K2(j));
			T = iadd(bitRol(T, rmd160_s2[j]), E2);
			A2 = E2; E2 = D2; D2 = bitRol(C2, 10); C2 = B2; B2 = T;
		}
...
return function (s, k, x, e) {
	...
	return x > 0 ? (e ? r2e(k, e) : k) : x < 0 ? r2b64(k) : r2hex(k);
};
...
* @returns {string}
* @example
* console.log(Sumi.Crypto.rmd160("abc"));
* // 8eb208f7e05d987a9b044a8e98c6b087f15a0bfc
* 
* console.log(Sumi.Crypto.rmd160('abc', 'key'));
