...
/**
* 对{@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp 正则表达式}中的特殊字符做转义处理。
...
/**
* 对{@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp 正则表达式}的特殊字符做反转义处理。
